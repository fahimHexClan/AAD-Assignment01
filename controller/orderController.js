...
/*Customer id eke combo box ekata id tika load karanawa*/
...
function populateItemIDs() {
    ...
    // customerArray and add options to the select element
...
function generateOrderId() {
    ...
    for (let i = 0; i < order_db.length; i++) {
        ...
        const numericPart = parseInt(order_db[i].order_id.split('-')[1]);//split eken num ekai - pace thiyala daganna eka wenne
...
// item input fields walata load wenawa btn tika set karanawa
...
//customer id name methana load wenawa
...
//table eka click karama input filed walta load wela btn disable karnao
